...
public class RightFlipper extends Flipper {
     ...
     * Sets the LineSegment representation to the Right Flipper's default position given its orientation
     * @param position
     * @param orientation
     */
    public RightFlipper(DoublePair position, Orientation orientation, List<Gadget> gadgets, boolean triggersSelf) {
    ...
    // (rotating clockwise)
    // 
    // 0 degrees: * |   (pivot in NE corner)
    //            * |
    // 
    // 90 degrees:  * *   (pivot in SE corner)
    //              - -
    // 
    // 180 degrees: | *   (pivot in SW corner)
    //              | * 
    // 
    // 270 degrees: - -   (pivot in NW corner)
    //              * * 
